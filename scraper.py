...
def fetch_image_urls(query: str, max_links_to_fetch: int, wd: webdriver, sleep_between_interactions: int = 1):
    ...
    while image_count < max_links_to_fetch:
        ...
        thumbnail_results = wd.find_elements(By.CSS_SELECTOR,
                                             "img.Q4LuWd")  # driver.find_element_by_class_name is no more working as thats been upgraded to this format of declaration
        ...
        for img in thumbnail_results[results_start:number_results]:
            ...
            # extract image urls
            actual_images = wd.find_elements(By.CLASS_NAME,
                                             value='r48jcc')  # Changed the selector to class name as the previous css selector was removed by google
